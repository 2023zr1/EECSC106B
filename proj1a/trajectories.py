...
class LinearTrajectory(Trajectory):
    ...
    # def v_func0(self, time):
    #     E = (self.end_position[0] - self.start_position[0])
    #     if time <= self.total_time/2:
    #         return (4*E/self.total_time**2)*time
    #     else:
    #         return (-4*E/self.total_time**2)*time + 4*E/self.total_time
    
    # def v_func1(self, time):
    #     E = (self.end_position[1] - self.start_position[1])
    #     if time <= self.total_time/2:
    #         return (4*E/self.total_time**2)*time
    #     else:
    #         return (-4*E/self.total_time**2)*time + 4*E/self.total_time
    ...
    # def v_func2(self, time):
    #     E = (self.end_position[2] - self.start_position[2])
    #     if time <= self.total_time/2:
    #         return (4*E/self.total_time**2)*time
    #     else:
    #         return (-4*E/self.total_time**2)*time + 4*E/self.total_time
