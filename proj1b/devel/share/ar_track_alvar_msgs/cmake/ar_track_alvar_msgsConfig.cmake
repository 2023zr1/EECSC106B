...
if("TRUE" STREQUAL "TRUE")
  set(ar_track_alvar_msgs_SOURCE_PREFIX /home/cc/ee106b/sp23/class/ee106b-acd/106b-sp23-project-starter/proj1b/src/ar_track_alvar/ar_track_alvar_msgs)
  set(ar_track_alvar_msgs_DEVEL_PREFIX /home/cc/ee106b/sp23/class/ee106b-acd/106b-sp23-project-starter/proj1b/devel)
  ...
  set(ar_track_alvar_msgs_INSTALL_PREFIX /home/cc/ee106b/sp23/class/ee106b-acd/106b-sp23-project-starter/proj1b/install)
...
if(NOT "/home/cc/ee106b/sp23/class/ee106b-acd/106b-sp23-project-starter/proj1b/devel/include " STREQUAL " ")
  set(ar_track_alvar_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/cc/ee106b/sp23/class/ee106b-acd/106b-sp23-project-starter/proj1b/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ar_track_alvar_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106b/sp23/class/ee106b-acd/106b-sp23-project-starter/proj1b/src/ar_track_alvar/ar_track_alvar_msgs/${idir}'.  ${_report}")
    endif()
